...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel')) && false ?: '_'}, '/videoCatalog/app', array('/videoCatalog/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form' => NULL)));
